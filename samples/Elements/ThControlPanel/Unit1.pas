...
uses
  ...
  FMX.Types, FMX.Controls, FMX.Forms, FMX.Dialogs, FMX.Objects, FMX.Colors;
...
type
  ...
  public
    ...
    property Over: TBrush read FOver write FOver;
...
begin
  ...
  FOver := TBrush.Create(TBrushKind.bkSolid, $FFE0E0E0);
  FOver.Kind := TBrushKind.bkGradient;
  FOver.Gradient.Color1 := $FF55FF55;
  FOver.Gradient.Color := $FF99FF99;
  FOver.Gradient.Style := TGradientStyle.gsRadial;
  FOver.Color := claGray;
